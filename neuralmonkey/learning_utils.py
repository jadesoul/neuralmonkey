...
def training_loop(tf_manager: TensorFlowManager,
    ...
    """
    if val_dataset is None and val_datasets is None:
        raise AssertionError("You must specify either val_dataset or val_datasets.")
    ...
    try:
        for epoch_n in range(1, epochs + 1):
            ...
            for batch_n, batch_dataset in enumerate(train_batched_datasets):
                ...
                for validation_dataset in val_datasets:
                    if step % validation_period == validation_period - 1:
                        ...
                        tf_manager.validation_hook(this_score,
                                                   epoch_n,
                                                   batch_n)
                        ...
                        log_print("")
                        _print_examples(validation_dataset,
                                        val_outputs,
